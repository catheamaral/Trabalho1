 ...
 * @author cathe
 */
@WebServlet(urlPatterns = {"/questao11"})
public class Questao11 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (n1 >= n2)
            response.sendRedirect("q11.jsp?status="+"recolet");
        for (int i = n1; i <= n2; i++)
            soma = soma + i;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Questao11</h1>");
            out.println("A soma entre os valores "+n1+" e "+n2+" é igual a "+soma);
            out.println("</body>");
            out.println("</html>");
        }
    }
