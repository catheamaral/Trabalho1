 ...
 * @author cathe
 */
@WebServlet(urlPatterns = {"/questao9"})
public class Questao9 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Questao9</h1>");
            
            if (n1==0 || n2==0 || n3==0)
                out.println("Número inválido moço!");
            else if (soma>=10)
                out.println("A soma foi maior que 10!");
            else if (soma<10)
                out.println("A soma foi menor que 10!");
            else if (soma < 0)
                out.println("A soma deu negativo moço!");
